...
import sunrise.DAO.impl.AdminDAOimpl;
import sunrise.DAO.impl.CategoryDAOimpl;
import sunrise.DAO.impl.CustomerDAOimpl;
import sunrise.DAO.impl.EmployeDAOempl;
import sunrise.DAO.impl.OrdersDAOimpl;
import sunrise.DAO.impl.ProductDAOimpl;
import sunrise.DAO.impl.UserDAOimpl;
	...
	//******************************cart******************************************************
        ...
        public @ResponseBody String reviewOrder(HttpServletRequest request,@ModelAttribute("user") Customer c,@ModelAttribute("cart") TreeMap<Product,Integer> cart){
			System.out.println("from reviewOrder controller");
			 ...
			 String day1=request.getParameter("date1").substring(0,2);
			 String day2=request.getParameter("date2").substring(0,2);
			
			 String month1=request.getParameter("date1").substring(3,5);
			 String month2=request.getParameter("date2").substring(3,5);
			 
			 System.out.println(day1+" "+day2+" "+month1+" "+month2);
			 String year1=request.getParameter("date1").substring(6,10);
			 String year2=request.getParameter("date2").substring(6,10);
		...
		public @ResponseBody String PlaceOrderFinal(HttpServletRequest request,@ModelAttribute("user") Customer c,@ModelAttribute("cart") TreeMap<Product,Integer> cart){
			...
			System.out.println("in the PlaceOrderFinal controller");
			 ...
			 String day1=request.getParameter("Start_date").substring(0,2);
			 String day2=request.getParameter("End_date").substring(0,2);
			
			 String month1=request.getParameter("Start_date").substring(3,5);
			 String month2=request.getParameter("End_date").substring(3,5);
			 
		
			 String year1=request.getParameter("Start_date").substring(6,10);
			 String year2=request.getParameter("End_date").substring(6,10);
			...
			{	str+="<div><h2 style='color: green'>Order Placed Successfully</h2></div>";
	             ...
	             str+=prodDAO.OrderSummaryTable(cart,((int) diffInDays)+1);
	             cart.clear();
	             str+="<a href='/SunriseBasketMVC/index.html' id='ContinueShopping' class='btn btn-large ContinueShopping'><i class='icon-arrow-left' ></i>Continue Shopping</a>";
	             str+="</div>";
			}
			else
			{
